    ...
    services: [
      {
        ...
        icon: "map-pin",
        promise: "A clear path through your first months.",
        get: "A step by step guide to the things that trip everyone up, CPR, MitID, tax card, bank, doctor, plus a person to ask when the guide is not enough.",
      ...
      },
      {
        ...
        get: "Drop-in help reading a letter, a contract, or an official form, so you understand what it asks and what to do next, and which office to take it to. This is practical guidance, not legal representation.",
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        get: "A plain language read of your employment contract, your notice terms, your holiday and pension, and a clear heads up on anything unusual before you sign. This is practical guidance, not legal representation.",
      ...
      },
      {
        ...
        get: "Help reading Danish salary benchmarks for your field and level, what is normal beyond base pay, and a script to negotiate without burning the offer.",
    ...
    services: [
      {
        ...
        get: "A rolling series on what matters, Danish workplace culture, networking that feels natural, taxes for newcomers, and digital tools, taught by people who have done it.",
      ...
      },
      {
        ...
        get: "Continues the pro-bono coaching InDe already runs, confidential sessions with a coach to work through a real challenge at work or in your transition.",
    ...
    services: [
      {
        ...
        get: "Regular InDe Meetup and InDe Connect events across Denmark, warm and low pressure, made for people who are far from where they grew up. Come once, come always.",
      ...
      },
      {
        ...
        get: "Gentle peer groups for the quiet weight of moving country, isolation, identity, and burnout. Peer support and clear routes to professional help, not therapy itself.",
